...
/**
 * <p>Java class for InventoryItemBinNumberList complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="binNumber" type="{urn:accounting_2016_1.lists.webservices.netsuite.com}InventoryItemBinNumber" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "InventoryItemBinNumberList", propOrder = {
    "binNumber"
})
public class InventoryItemBinNumberList {
     ...
     * {@link InventoryItemBinNumber }
     * 
     * 
     */
    public List<InventoryItemBinNumber> getBinNumber() {
        if (binNumber == null) {
            binNumber = new ArrayList<InventoryItemBinNumber>();
        }
