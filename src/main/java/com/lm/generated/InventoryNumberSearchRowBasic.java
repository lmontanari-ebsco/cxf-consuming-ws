...
/**
 * <p>Java class for InventoryNumberSearchRowBasic complex type.
 * 
 ...
 *         &lt;element name="inventoryNumber" type="{urn:core_2016_1.platform.webservices.netsuite.com}SearchColumnStringField" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="isonhand" type="{urn:core_2016_1.platform.webservices.netsuite.com}SearchColumnBooleanField" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="quantityintransit" type="{urn:core_2016_1.platform.webservices.netsuite.com}SearchColumnDoubleField" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "InventoryNumberSearchRowBasic", namespace = "urn:common_2016_1.platform.webservices.netsuite.com", propOrder = {
    "expirationDate",
    "externalId",
    "internalId",
    "inventoryNumber",
    ...
    extends SearchRowBasic
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the isonhand property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<SearchColumnBooleanField> getIsonhand() {
        if (isonhand == null) {
            isonhand = new ArrayList<SearchColumnBooleanField>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the quantityintransit property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<SearchColumnDoubleField> getQuantityintransit() {
        if (quantityintransit == null) {
            quantityintransit = new ArrayList<SearchColumnDoubleField>();
        }
